...
- [`planning/ft04-prequeue-observability-plan.md`](planning/ft04-prequeue-observability-plan.md) — FT-04 #151 PLAN: secret-free webhook disposition observability (no behavior change).
